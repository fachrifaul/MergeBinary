        ...
        Pod::Spec.new do |s|
          ...
          s.source_files = 'MergedPods/UISwift/Sources/**/*.{h,m,mm,swift,c}'
        
s.swift_version = ["5.0"]
s.resource = "MergedPods/UISwift/Sources/IQKeyboardManagerSwift/IQKeyboardManagerSwift/Resources/IQKeyboardManager.bundle", "MergedPods/UISwift/Sources/NVActivityIndicatorView/NVActivityIndicatorView/NVActivityIndicatorView/Images.xcassets"
s.frameworks = "UIKit", "Foundation", "CoreGraphics", "QuartzCore"
s.public_header_files = ["MergedPods/UISwift/Sources/lottie-ios/lottie-ios/Classes/PublicHeaders/*.h"]
end
